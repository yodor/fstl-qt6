...
#include <QOpenGLShaderProgram>      // Still correct
#include <QSurfaceFormat>            // Still correct
#include <QOpenGLWidget>             // ← Changed
#include <QOpenGLFunctions>          // Still correct
#include <QPropertyAnimation>   // ← Add this line
