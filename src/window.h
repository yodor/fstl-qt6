...
public slots:
    void on_open();
    void on_open_external();           // ← Removed 'const'
    void on_about();
    void on_bad_stl();
    void on_empty_mesh();
...
private:
    ...
    static const QString RECENT_FILE_KEY;
    static const QString INVERT_ZOOM_KEY;
    static const QString AUTORELOAD_KEY;
    static const QString DRAW_AXES_KEY;
    static const QString PROJECTION_KEY;
    static const QString DRAW_MODE_KEY;
    static const QString WINDOW_GEOM_KEY;
    static const QString RESET_TRANSFORM_ON_LOAD_KEY;
